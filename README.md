...
Eyris Lite is a free Next.js 16 admin dashboard template, built with React 19, Tailwind CSS 4, and TypeScript. Skip the boilerplate: auth, dark mode, and a working dashboard are wired up.
